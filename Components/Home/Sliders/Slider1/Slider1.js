                    ...
                    {this.props.SliderDetail.map((slide, index) => (
                        ...
                        >
                            <div className="slider__slide-content">
                                <h3  style={{fontFamily : 'vazir' , direction : 'ltr'}} className="slider__slide-subheading text-center">{slide.country || slide.city}</h3>
                                <h2  style={{fontFamily : 'vazir' , direction : 'ltr'}} className="slider__slide-heading text-center">
                                     <span style={{fontFamily : 'vazir' , direction : 'ltr'}}>{slide.city}</span>
                                </h2>
                                <p className="slider__slide-readmore  text-center">اطلاعات بیشتر</p>
                            </div>
