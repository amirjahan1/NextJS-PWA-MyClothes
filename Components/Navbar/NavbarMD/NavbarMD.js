    ...
    return(
        ...
        <nav style={{
            ...
            <ul    className="flex justify-between bg-blue-500 items-center px-2 ">
                ...
                <ul style={{ height : "100vh" , width : "50vw"}} className={` ${nav ? "block animate__animated animate__slideInRight " : "  animate__animated animate__slideOutRight "}  top-0 z-10 pt-5 text-xl w-1/3 l text-blueGray-600 2 bg-blue-500`}>
